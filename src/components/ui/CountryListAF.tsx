...
const countriesAF = countries.filter((c) => /^[A-Fa-f]/.test(c.name));

// Group countries by first letter
const grouped = countriesAF.reduce(
  (acc, country) => {
  ...
  {} as Record<string, typeof countriesAF>
);

export default function CountryListAF() {
  return (
