    ...
    return (
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 text-center">
        ...
        <p className="text-gray-700 mb-4">
          ...
          <a href="mailto:Visa@VietnamImmigration.com" className="text-brand-primary underline">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a
            href="mailto:Visa@VietnamImmigration.com?subject=Documents for Application {uploadError.applicationId}"
