---
title: 'Extend Vietnam eVisa in 2026? Rules Explained'
...
faq:
  - question: Can you extend a Vietnam eVisa online?
    answer: Usually no. Extensions, when available, are handled at immigration offices inside Vietnam before your current stay expires—not through the original eVisa portal.
  - question: How long can a Vietnam eVisa extension add?
    answer: Extra days depend on visa type, nationality, and the officer’s decision. Do not assume another full 90 days automatically.
  - question: What happens if I overstay my Vietnam eVisa?
    answer: Overstaying can lead to fines, deportation, and future entry bans. Contact immigration immediately if you realize you will miss your exit date.
  - question: Is it better to apply for a longer eVisa upfront?
    answer: Yes. Choosing 60–90 days or multiple entry during initial filing on apply is safer than betting on an in-country extension later.
---
...
If you already know you need **60–90 days**, choose the longer eVisa option during initial filing on [/apply](/apply) instead of betting on an extension later.

Compare stay lengths on [/fees](/fees) and nationality rules on [/check-requirement](/check-requirement).
...
Read [/blog/vietnam-evisa-vs-embassy-visa-2026](/blog/vietnam-evisa-vs-embassy-visa-2026) and [/blog/vietnam-evisa-multiple-entry-guide-2026](/blog/vietnam-evisa-multiple-entry-guide-2026).

## Step-by-step: extension appointment (typical flow)

While procedures vary by city, most travelers follow this pattern:

1. **Book or walk in** to the provincial immigration department (bring your hotel address in Vietnamese if possible).
2. Submit **Form NA5** (or the current extension form—staff will provide the latest version).
3. Pay the **extension fee** in VND (cash or bank transfer per office rules).
4. Leave your passport for **3–7 working days** or collect same-day if express service exists.
5. Receive an **extension stamp or approval slip** showing a new exit date.
...
Rejected extensions do not automatically refund prior visa fees—see [/refund-policy](/refund-policy).

## Related FAQs

- [/faq/vietnam-evisa-requirements](/faq/vietnam-evisa-requirements) — stay lengths and visa types
- [/blog/vietnam-evisa-processing-time-2026](/blog/vietnam-evisa-processing-time-2026) — timing a new application
- [/blog/vietnam-evisa-fees-explained-2026](/blog/vietnam-evisa-fees-explained-2026) — budgeting government vs service fees
...
Choose the correct duration on [/apply](/apply) before you travel.

[Apply for the correct Vietnam eVisa duration](/apply) before you book non-refundable stays.
