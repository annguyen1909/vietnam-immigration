...
faq:
  ...
  - question: Will I be charged twice if I retry after a failed payment?
    answer: Usually no. A declined or failed authorization should not post a completed charge. If you see a pending hold, it typically drops off within a few business days per your bank's policy.
  - question: Can I still board my flight if my eVisa payment failed?
    answer: Not with a valid approved eVisa. Airlines check your authorization before departure. Without approval (or another eligible entry document), you risk being denied boarding even with a paid flight ticket.
  - question: How fast can your team help after a payment failure?
    answer: When documents are ready and you are eligible, rush review often targets about 2 hours. Same-day departures need immediate action—retrying blindly for hours usually wastes your window.
howToSteps:
  - name: Capture the exact error message
    text: Screenshot the decline code or message and note the time, browser, and card type (Visa/Mastercard/debit) before you retry.
  - name: Confirm card and billing details
    text: Enable international or online purchases with your bank, then ensure name, postal code, and country match your bank records exactly.
  - name: Remove VPN and start a clean session
    text: Disable VPN or proxy, clear cache or use a private window, and attempt one controlled payment—not dozens of rapid retries.
  - name: Escalate to rush review if departure is soon
    text: If you fly within 24 hours, submit a rush application or contact support with your error details, nationality, and travel date.
---
...
Document the exact error message, confirm whether your bank shows a block or hold, and note your passport nationality. Then [start a rush application](/apply) or [contact our support team](/contact) with any reference number you already have—we will tell you plainly what can be fixed before you travel.
