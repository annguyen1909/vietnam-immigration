---
title: Vietnam eVisa Still Processing After 48 Hours? When to Wait vs Escalate
description: Applied 2 days ago and still no Vietnam eVisa approval? Learn normal 48-hour windows, weekend rules, and when pending status needs action—not a duplicate application.
slug: evisa-processing-48-hours
date: 2026-06-23
updated: 2026-06-23
index: true
priority: 0.95
howToTotalTime: PT2H
faq:
  - question: Is it normal for a Vietnam eVisa to still be processing after 48 hours?
    answer: Often yes—especially on Normal tier, weekends, or Vietnamese public holidays. Forty-eight clock hours is not always two business days. Super Urgent targets one business day; Urgent targets three; Normal targets up to five business days.
  - question: Why is my Vietnam eVisa still processing after 2 days?
    answer: Common reasons include weekend or holiday queues, peak season volume, manual document review, incomplete payment showing as pending, or an email typo sending approval elsewhere. Forty-eight hours alone is rarely grounds to reapply.
  - question: Should I apply again if my eVisa is still processing after 48 hours?
    answer: Usually no. Duplicate applications cause fraud delays. Confirm payment, search all email folders, and wait until your tier business-day window passes—or contact support with your reference number.
  - question: When should I worry if my Vietnam eVisa is still pending?
    answer: Escalate when you exceed your tier window on business days, payment never posted, you received a document resubmission request you have not answered, or departure is within 72 hours without approval.
howToSteps:
  - name: Count business days—not just calendar hours
    text: Exclude Saturdays, Sundays, and Vietnamese public holidays from your tier window. A Friday submission may show no movement until Monday or Tuesday.
  - name: Confirm payment posted successfully
    text: Verify a completed charge on your bank statement—not only a pending hold. Unfulfilled or unpaid applications never enter review—see our Unfulfilled status guide.
  - name: Search all email folders including spam
    text: Approval or document-request emails may hide in spam or promotions. Search your reference number and "eVisa" across every inbox you might have used.
  - name: Check for a photo or document resubmission request
    text: Pending can mean immigration is waiting for you—not that your file is lost. Open every email from the application before assuming silence means delay.
  - name: Contact support if your tier window is exceeded
    text: Provide reference number, tier selected, application date, and travel date. Ask about urgency upgrade—not a duplicate application unless support advises it.
---
...
Full tier detail: [processing time 2026](/blog/vietnam-evisa-processing-time-2026).  
Longer delays: [pending 5+ days](/troubleshooting/stuck-processing).
...
Holiday guide: [weekend and holiday processing](/troubleshooting/weekend-processing).
...
Check: [photo rejected](/troubleshooting/photo-rejected).

### Payment or Unfulfilled confusion

If payment never fully posted, status may look stuck when the application never entered the queue. Verify bank charges—read [Unfulfilled status](/troubleshooting/evisa-unfulfilled-status) and [payment failed](/troubleshooting/payment-failed).
...
3. **Count business days** since submission, not total hours
...
3. **Change flights** before tier window ends (unless Super Urgent missed)
4. **Spam refresh** hundreds of times—it does not speed review

## When 48 hours **does** mean escalate

Contact [support](/contact) immediately if:
...
| **Unfulfilled** status, not Processing | Different problem—[Unfulfilled guide](/troubleshooting/evisa-unfulfilled-status) |
...
Check your country page for tips: [/check-requirement](/check-requirement).
...
After 5+ business days on Normal: [stuck processing guide](/troubleshooting/stuck-processing).
...
| Portal Unfulfilled | No—payment step | [Unfulfilled guide](/troubleshooting/evisa-unfulfilled-status) |
| Email asking for new photo | Processing paused for you | Respond same day—[photo guide](/troubleshooting/photo-rejected) |
| Bank shows no posted charge | Never entered queue | [Payment failed](/troubleshooting/payment-failed) |
...
- Avoids [duplicate application](/troubleshooting/duplicate-evisa-application) fraud flags
- Preserves original payment where policy allows
- Targets faster review when eligibility and arrival date support it

See [/fees](/fees) for tier definitions and [/processing](/processing) for service overview.
...
During peaks, **72 hours on Normal tier without email** can still be within expectations—see [weekend and holiday processing](/troubleshooting/weekend-processing).

## What not to do at hour 47

Travelers at the psychological 48-hour mark often:

- File duplicate applications ([duplicate guide](/troubleshooting/duplicate-evisa-application))
...
Paste into [contact](/contact) with attachments—faster than submitting a duplicate application.
...
- [Pending 5+ days](/troubleshooting/stuck-processing)
- [Weekend delays](/troubleshooting/weekend-processing)
- [Unfulfilled status](/troubleshooting/evisa-unfulfilled-status)
- [Duplicate application mistakes](/troubleshooting/duplicate-evisa-application)
- [24-hour options](/faq/24-hour-vietnam-evisa)
- [Processing time 2026](/blog/vietnam-evisa-processing-time-2026)

## Flying within 3 days and still processing at 48 hours?

Do not wait passively. [Contact support](/contact) with reference number and flight details, or ask about [Super Urgent re-filing](/apply) after support reviews your current filing status.
